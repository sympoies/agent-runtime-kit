...
- Release:
  ...
  `main`
- `v1.28.28` is the validated release, and `v1.27.35` is the compatibility
  minimum. This adoption moved validated only.
- `v1.28.28` adds the `devlog` binary, which is why this adoption happened.
