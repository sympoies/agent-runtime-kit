...
- For an active goal decision, use the harness question tool when available, not a plain-text question. Otherwise follow the injected blocked-audit contract; do not stop prematurely. Only the user's later explicit selection authorizes it.
