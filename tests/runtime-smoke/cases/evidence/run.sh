...
matches_pinned_agent_docs_version() {
  grep -Eq '^agent-docs 1\.23\.0([[:space:]]|$)' <<<"$1"
}
...
run_selective_intent_control_plane_probe() {
  ...
  matches_pinned_agent_docs_version "agent-docs 1.23.0"
  ! matches_pinned_agent_docs_version "agent-docs 1.23.00"
  ! matches_pinned_agent_docs_version "agent-docs 11.23.0"
