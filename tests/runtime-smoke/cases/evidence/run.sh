...
matches_pinned_agent_docs_version() {
  grep -Eq '^agent-docs 1\.22\.7([[:space:]]|$)' <<<"$1"
}
...
run_selective_intent_control_plane_probe() {
  ...
  matches_pinned_agent_docs_version "agent-docs 1.22.7"
  ! matches_pinned_agent_docs_version "agent-docs 1.22.70"
  ! matches_pinned_agent_docs_version "agent-docs 11.22.7"
