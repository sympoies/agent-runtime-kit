...
matches_pinned_agent_docs_version() {
  grep -Eq '^agent-docs 1\.22\.12([[:space:]]|$)' <<<"$1"
}
...
run_selective_intent_control_plane_probe() {
  ...
  matches_pinned_agent_docs_version "agent-docs 1.22.12"
  ! matches_pinned_agent_docs_version "agent-docs 1.22.120"
  ! matches_pinned_agent_docs_version "agent-docs 11.22.12"
