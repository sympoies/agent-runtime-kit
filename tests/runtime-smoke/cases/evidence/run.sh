...
matches_pinned_agent_docs_version() {
  grep -Eq '^agent-docs 1\.21\.34([[:space:]]|$)' <<<"$1"
}
...
run_selective_intent_control_plane_probe() {
  ...
  matches_pinned_agent_docs_version "agent-docs 1.21.34"
  ! matches_pinned_agent_docs_version "agent-docs 1.21.340"
  ! matches_pinned_agent_docs_version "agent-docs 11.21.34"
