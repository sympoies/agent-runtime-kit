...
matches_pinned_agent_docs_version() {
  grep -Eq '^agent-docs 1\.24\.3([[:space:]]|$)' <<<"$1"
}
...
run_selective_intent_control_plane_probe() {
  ...
  matches_pinned_agent_docs_version "agent-docs 1.24.3"
  ! matches_pinned_agent_docs_version "agent-docs 1.24.30"
  ! matches_pinned_agent_docs_version "agent-docs 11.24.3"
