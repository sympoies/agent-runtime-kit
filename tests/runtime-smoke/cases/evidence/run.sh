...
matches_pinned_agent_docs_version() {
  grep -Eq '^agent-docs 1\.21\.24([[:space:]]|$)' <<<"$1"
}
...
run_selective_intent_control_plane_probe() {
  ...
  matches_pinned_agent_docs_version "agent-docs 1.21.24"
  ! matches_pinned_agent_docs_version "agent-docs 1.21.240"
  ! matches_pinned_agent_docs_version "agent-docs 11.21.24"
