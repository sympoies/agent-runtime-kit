...
|---|---|---|
| Codex CLI (`codex --version`) | `0.150.1` (effective 2026-09-01) | `manifests/runtime-roots.yaml` |
| Claude Code (`claude --version`) | `2.1.247` (effective 2026-09-01) | `manifests/runtime-roots.yaml` |
