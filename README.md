...
|---|---|---|
| Codex CLI (`codex --version`) | `0.153.0` (effective 2026-09-21) | `manifests/runtime-roots.yaml` |
...
| `nils-cli` surface (`agent-runtime --version`) | minimum `v1.28.30`; validated `v1.28.30` | `docs/source/nils-cli-surface.md` |
